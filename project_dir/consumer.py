...
connection = pika.BlockingConnection(pika.ConnectionParameters(RABBITMQ_HOST, heartbeat=600, blocked_connection_timeout=300))
...
channel.basic_consume(queue='messasges', on_message_callback=callback, auto_ack=True)
